    ...
    >
      ...
      >
        ...
        <v-card
          ...
          elevation="2"
        >
          <v-icon class="info-icon mr-4" color="white">mdi-information-outline</v-icon>
          <div class="info-text">
            Создавая профиль, нажимая на кнопку, вы даёте согласие на обработку персональных данных
            и рассылку информационных сообщений <a href="https://www.consultant.ru/document/cons_doc_LAW_61801/" class="link">согласно закону</a>
